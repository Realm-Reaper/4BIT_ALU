...
HD_PWD='C:/Vivado_Projects/4Alu/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_TopModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_TopModule.tcl
