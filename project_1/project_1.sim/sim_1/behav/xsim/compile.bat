...
REM
REM Generated by Vivado on Fri Apr 24 19:09:35 +0530 2026
...
echo "xvlog --incr --relax -prj TopModule_Test_vlog.prj"
call xvlog  --incr --relax -prj TopModule_Test_vlog.prj -log xvlog.log
